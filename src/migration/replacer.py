...
def main():
    ...
    for filename in json_files:
        ...
        pretty_replaced = utils.replace(pretty_replaced, '            "timeFrom": "now-2y",\n', '')
        pretty_replaced = utils.replace(pretty_replaced, '"timeRestore": true', '"timeRestore": false')
        pretty_replaced = utils.replace(pretty_replaced, '            "timeTo": "now",\n', '')
